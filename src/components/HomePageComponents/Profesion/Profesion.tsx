                ...
                <div className={classes.insideWrapper}>
                    <div className={classes.UPblock}>
                        ...
                        <div className={classes.block2}>
                            ...
                            <p className={classes.text}>
                                I specialize in developing interfaces using Next.js, React, TypeScript, and SCSS.
                                I like to turn complex ideas into simple and understandable solutions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={classes.BOTTOMblock}>
                        <div className={classes.block3}>
                            ...
                            <p className={classes.text}>
                                My goal is to improve every day, create projects that inspire,
                                and develop towards a full stack, combining the frontend and backend into a single whole.
                            </p>
                        </div>
                    </div>
                </div>
